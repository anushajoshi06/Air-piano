...
Each notes in a piano will have certain frequency values. By creating those frequency signals using Arduino we can produce tones identical to the piano. 
